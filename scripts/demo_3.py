...
csv_path = '/home/ye/ros_ws/src/baxter_pydmps/data/endpoint_record_3.csv'
data_csv = pd.read_csv(csv_path)
raw_data = data_csv.values[:, 1:4].astype(float)
...
ax.scatter(filtered_data[-1, 0], filtered_data[-1, 1], filtered_data[-1, 2], color="g", s=100)
